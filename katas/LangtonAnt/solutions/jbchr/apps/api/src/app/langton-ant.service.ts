...
export class LangtonAntService {
   ...
   * The algorithm's data structure is close to the outputs data structure.
   *
   ...
   * ]
   *
   * @returns the game as an array of turns. Each turn consists of all fields of the board.
   */
  computeGame(
    boardLength: number,
    antPosX: number,
